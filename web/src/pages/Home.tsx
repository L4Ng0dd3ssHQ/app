...
export default function Home() {
  ...
  return (
    <div className="px-4 pt-6" data-testid="home-screen">
      ...
      <Link
        to="/pro"
        className="flex items-center justify-between gap-2 bg-brand-500 text-brand-800 rounded-2xl px-4 py-3 mb-4 shadow-card active:scale-[0.98] transition-transform"
      >
